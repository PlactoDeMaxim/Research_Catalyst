...
electronic file, trans jour.docx, from the IEEE Web site at
www.ieee.org/authortools so you can use it to prepare
your manuscript. If you would prefer to use LATEX,
download IEEE’s LATEX style and sample files from the
same Web page. You can also explore using the Overleaf
editor at https://www.overleaf.com/blog/278-how-to-useoverleaf-
with-ieee-collabratec-your-quick-guide-to-gettingstarted\#.
Vp6tpPkrKM9
