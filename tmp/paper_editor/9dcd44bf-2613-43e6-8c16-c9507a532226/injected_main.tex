...
t for magnetic field strength $H

t et al}.'' (it is also italicized). The abbreviation ``i.e.,'
% cleared by paper editor injection

an extra expense to the author. If you intend to have print color graphics, include a note with your final paper indicating which figures or tables you would like to be handled that way, and stating that you are willing to pay the additional fee.
